...
train = pd.read_csv(r"C:\Users\Naruto\Desktop\generative_ai\PROJECTS\flight_price_prediction\data\train.csv")
...
)).astype({   # pandas to_datetime() will not work on streamlit object, so we convert "date_of_journey", "dep_time", "arrival_time" to str first.
	col: "str"
